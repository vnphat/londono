    ...
    t.prototype = {
        ...
        _b2: function () {
            ...
            /*hieuhiti add key*/
                ...
                f, c, g = function (a) {
                    b.st.keynext === a ? b.prev() :  b.st.keyprev === a && b.next()
                };
            b._b.on("keydown" + b.ns, function (a) {
                if (!b._l2 && (c = a.keyCode, (b.st.keynext === c || b.st.keyprev === c) && !f)) g(c), f = setInterval(function () {
                    g(c)
                }, 700)
    ...
    j.extend(j.rsProto, {
        _p4: function () {
            ...
            a.ev.on("rsBeforeParseNode", function (a, b, d) {
                b = j(b);
                d.animBlocks = b.find(".phantu").css("display", "none");
                d.animBlocks.length || (d.animBlocks = b.hasClass("phantu") ? b.css("display", "none") : !1)
            });
    ...
    e.extend(e.rsProto, {
        _f6: function () {
            ...
            "tabs" === a.st.controlNavigation && (a.ev.on("rsBeforeParseNode", function (a, d, b) {
                d = e(d);
                b.thumbnail = d.children(".rsTmb").remove();
                b.thumbnail.length ? b.thumbnail = e(document.createElement("div")).append(b.thumbnail).html() : (b.thumbnail = d.attr("data-rsTmb"), b.thumbnail || (b.thumbnail = d.find(".rsImg").attr("data-rsTmb")), b.thumbnail = b.thumbnail ? '<img src="' + b.thumbnail + '"/>' : "")
            }), a.ev.one("rsAfterPropsSetup", function () {
                a._g6()
            }), a.ev.on("rsOnAppendSlide",
                function (c, d, b) {
                    b >= a.numSlides ? a._k5.append('<li class="rsNavItem rsTab">' + d.thumbnail + "</li>") : a._l5.eq(b).before('<li class="rsNavItem rsTab">' + item.thumbnail + "</li>");
                    a._l5 = a._k5.children()
                ...
                var c = a.currSlideId;
                a._n5 && a._n5.removeClass("mesele");
                c = a._l5.eq(c);
                c.addClass("mesele");
                a._n5 = c
            }))
        ...
        _g6: function () {
            ...
            a._j5 = !0;
            /* remove Hieuhiti
            c = '<div class="grptab"><div class="rsNav rsTabs">';
            ...
            ed remove hieuhiti*/
            /*bg add hieuhiti*/
            c = '<ul class="rsNav rsTabs menuchild ">';
            for (var d = 0; d < a.numSlides; d++) c += '<li class="rsNavItem"><a href="javascript:void(0)">'+ a.slides[d].thumbnail + "</a></li>";
            c = e(c + "</ul>");
            a._k5 = c;
            a._l5 = c.children(".rsNavItem");

            $(a.st.targetcl).append(c);
            /*ed add hieuhiti*/
